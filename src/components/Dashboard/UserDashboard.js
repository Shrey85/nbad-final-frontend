...
const Dashboard = ({ token, username }) => {
  ...
  return (
    <div>
      <h1 className="personalbudget">Personalized Budget Center</h1>
      <p className="personalbudget">Discover your ultimate budget management hub!</p>
  ...
  <ul>
    ...
    <li>
      ...
      >
        ...
        <p>Are you interested in continuing our session to proceed with your tasks?</p>
